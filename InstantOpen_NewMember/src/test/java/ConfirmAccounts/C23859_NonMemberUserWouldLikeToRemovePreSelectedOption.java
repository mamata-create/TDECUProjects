...
public class C23859_NonMemberUserWouldLikeToRemovePreSelectedOption extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Non member user can remove pre-selected option
	 */
	@BeforeTest
	...
	@Test
	public void C23859_NonMemberUserWouldLikeToRemovePreSelectedOption() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Name suffix entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Non member user can remove pre-selected option");
		}
	}
