...
//				cap.setCapability("resetKeyboard", true);
				...
				cap.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.kone.tdecu.TDECUMob");
				
				cap.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.kone.tdecu");
