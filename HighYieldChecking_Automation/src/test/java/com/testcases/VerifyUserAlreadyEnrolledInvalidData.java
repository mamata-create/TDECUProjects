...
public class VerifyUserAlreadyEnrolledInvalidData extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify User already  Enrolled invalid data
	 */
	...
	@Test
	public void VerifyUserAlreadyEnrolledInvalidData() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify User Already Enrolled Invalid data scenario working fine");
		}
	}
