...
public class C24228_NonMemberUserCanGetMobileDepositLinkIfOptionSelected extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Non member user can see mobile deposit linkif respective option is selected
	 */
	@BeforeTest
	...
	@Test
	public void C24228_NonMemberUserCanGetMobileDepositLinkIfOptionSelected() throws InterruptedException, MessagingException, IOException
	{
...
//					}
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Non member user can see mobile deposit linkif respective option is selected");
		}
	}
