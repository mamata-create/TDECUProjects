...
public class TDB2608_VerifyEverySixMonthOtherTdecuTransfer extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	
	/*
	 * TDB2608 - Verify Every Six Month Other TDECU Transfer
	 */
	...
	@Test
	public void TDB2608_VerifyEverySixMonthOtherTdecuTransfer()throws InterruptedException{
	...
	//select frequency as Every six months	
		selectDropdownOpt(ObjectRepository.frequencydrop,"Every Six Months");
		verifyDropdownSelection(ObjectRepository.frequencydrop,"Every Six Months");
		test.log(Status.INFO, "Frequency selected as Every Six Months and verified" );
		Thread.sleep(2000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Monthly Other TDECU account transfer scenario working fine");
		}
	}
