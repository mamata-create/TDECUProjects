...
public class C23526_VerifyConsumerLoanGreaterThanAmountPayment  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Consumer Loan greater than amount Payment
	 */
	...
	@Test
	public void C23526_VerifyConsumerLoanGreaterThanAmountPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Consumer loan greater than amount payment scenario working fine");
		}
	}
