...
public class C24176_VerifyValidVehicleInfo extends GenericKeywords{
  ...
  @Test
  public void C24176_VerifyValidVehicleInfo() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify vehicle loan field data for existing member");
		}
	}
