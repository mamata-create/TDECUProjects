...
public class C24258_NonMemberUserShouldBeWarnedIfTheInformationNeedsToBeSaved extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user should be warned if their entered information needs to be saved
	 */
	...
	@Test
	public void C24258_NonMemberUserShouldBeWarnedIfTheInformationNeedsToBeSaved() throws InterruptedException, MessagingException, IOException
	{
