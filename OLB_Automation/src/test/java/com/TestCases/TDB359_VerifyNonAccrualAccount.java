...
public class TDB359_VerifyNonAccrualAccount  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB359 - Verify NonAccrual Account
	 */
	...
	@Test
				public void VerifyNonAccrualAccount() throws InterruptedException
			{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Non Accrual Account Type scenario working fine");
		}
	}
