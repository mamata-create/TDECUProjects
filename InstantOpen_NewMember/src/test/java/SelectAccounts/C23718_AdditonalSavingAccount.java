...
public class C23718_AdditonalSavingAccount extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * To add additional Savings Account
	 */
	...
	@Test
	public void C23718_AdditonalSavingAccount() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String savingsAccountText = getElement(ObjectRepository.savingsAccountText).getAttribute("innerText");
					if(savingsAccountText.contains("Additional savings account available to all Members")){
						Assert.assertTrue(true, "Text matched");
					}
...
//					
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "To add additional Savings Account");
		}
	}
