...
public class TDB2056_Verify45DaysMyTdecuTransfer extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
/*
 * TDB-2056 - verify Tdecu transfer after 45
 */
	...
	@Test
	public void TDB2056_Verify45DaysMyTdecuTransfer() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//select frequency as Quarterly and No of Recurrences	
					...
					Thread.sleep(2000);
					verifyText(ObjectRepository.frmaccntwarning,"Please enter a date that is within 45 days of today’s date");
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "My TDECU account transfer 45days scenario working fine");
	}
}
