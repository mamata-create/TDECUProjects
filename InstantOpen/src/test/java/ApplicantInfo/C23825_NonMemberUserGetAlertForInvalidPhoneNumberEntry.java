...
public class C23825_NonMemberUserGetAlertForInvalidPhoneNumberEntry extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that user can get Alert for Invalid Phone number entry
	 */
	...
	@Test
	public void C23825_NonMemberUserGetAlertForInvalidPhoneNumberEntry() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Name suffix entered");
					...
					//Entering letters in the phone number field 
					getElement(ObjectRepository.phonenmbr_txt).clear();
					getElement(ObjectRepository.phonenmbr_txt).sendKeys("phone");
					
					//Entering special Chars
					getElement(ObjectRepository.phonenmbr_txt).sendKeys("@#$%");
					getElement(ObjectRepository.phonenmbr_txt).sendKeys(Keys.TAB);
					verifyText(ObjectRepository.phoneNumber_alert,"Please enter a valid value");
					
					//Entering less than 10 digits
					getElement(ObjectRepository.phonenmbr_txt).click();
					getElement(ObjectRepository.phonenmbr_txt).clear();
					getElement(ObjectRepository.phonenmbr_txt).sendKeys("897431562");
					getElement(ObjectRepository.phonenmbr_txt).sendKeys(Keys.TAB);
					verifyText(ObjectRepository.phoneNumber_alert,"Please enter a valid value");
					...
					getElement(ObjectRepository.phonenmbr_txt).click();
					getElement(ObjectRepository.phonenmbr_txt).clear();
					getElement(ObjectRepository.phonenmbr_txt).sendKeys("89743156212");
					getElement(ObjectRepository.phonenmbr_txt).sendKeys(Keys.TAB);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that user can get Alert for Invalid Phone number entry");
		}
	}
