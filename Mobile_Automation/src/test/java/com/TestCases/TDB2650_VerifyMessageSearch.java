...
public class TDB2650_VerifyMessageSearch extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2650 - Verify Message Search
	 */
	@Test
	public void TDB2650_VerifyMessageSearch() throws InterruptedException{
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Message Search scenario working fine");
		}
	}
