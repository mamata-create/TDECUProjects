...
public class VerifyChargeOffAccountDisplayed extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify charge off account displayed
	 */
	...
	@Test
	public void VerifyChargeOffAccountDisplayed() throws InterruptedException {
		if (continuetestcase == true) {
			...
			for (startIter = 1; startIter <= totalRowCount; startIter++) 
			{
				...
				//Page2
					...
					test.log(Status.INFO, "Charge Off account available");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify charge off account displayed scenario working fine");
		}
	}
