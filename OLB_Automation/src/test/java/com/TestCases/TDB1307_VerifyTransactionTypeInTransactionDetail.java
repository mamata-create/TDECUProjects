...
public class TDB1307_VerifyTransactionTypeInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB1307_VerifyTransactionTypeInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		test.log(Status.INFO, "Transaction Detail page opened");
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctntyp, "Deposit");
		test.log(Status.INFO, "Transaction type verified on the transaction detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Transaction Type in Transaction Detail scenario working fine");
	}
}
