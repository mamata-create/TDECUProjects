...
public class C28364_VerifyTheLanguageOntheConfirmAccountPage extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * As TDECU, I want to improve the language on the Confirm Account Selection page.
	 */
	@BeforeTest
	...
	@Test
	public void C28364_VerifyTheLanguageOntheConfirmAccountPage() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Name suffix entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "As TDECU, I want to improve the language on the Confirm Account Selection page.");
		}
	}
