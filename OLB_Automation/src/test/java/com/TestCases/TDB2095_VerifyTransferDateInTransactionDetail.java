...
public class TDB2095_VerifyTransferDateInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2095_VerifyTransferDateInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		verifyText(ObjectRepository.trnsctnfrqncy, expDate);
		test.log(Status.INFO, "Transaction date verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify transfer date in Transaction Detail scenario working fine");
	}
}
