...
public class TDB2098_VerifyDestinationAccountInPostedTransaction extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2098_VerifyDestinationAccountInPostedTransaction() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		test.log(Status.INFO, "Destination Account verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Destination Account in Posted Transaction Detail scenario working fine");
	}
}
