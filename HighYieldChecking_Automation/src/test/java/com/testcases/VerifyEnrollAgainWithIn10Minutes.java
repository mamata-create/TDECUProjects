...
public class VerifyEnrollAgainWithIn10Minutes  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify   Enroll again within 10 minutes
	 */
	...
	@Test
	public void VerifyEnrollAgainWithIn10Minutes() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Enroll again within 10minutes scenario working fine");
		}
	}
