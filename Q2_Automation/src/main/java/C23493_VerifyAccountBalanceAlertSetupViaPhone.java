...
public class C23493_VerifyAccountBalanceAlertSetupViaPhone extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Account Balance alert SetUp via phone
	 * 
	 */
...
//				Thread.sleep(7000);
	...
	@Test
	public void C23493_VerifyAccountBalanceAlertSetupViaPhone() throws InterruptedException, MessagingException, IOException
	{
...
//					
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Account Balance Alert Setup Via Phone scenario working fine");
		}
	}
