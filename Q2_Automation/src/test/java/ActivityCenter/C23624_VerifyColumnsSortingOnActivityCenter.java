...
public class C23624_VerifyColumnsSortingOnActivityCenter extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Columns Sorting on Activity Center
	 */
	...
	@Test
	public void C23624_VerifyColumnsSortingOnActivityCenter() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Columns Sorting on Activity Center scenario working fine");
		}
	}
