...
public class C24270_VerifyCerticateOfDepositDefaultFundingAmount   extends GenericKeywords{
  ...
  @Test
  public void C24270_VerifyCerticateOfDepositDefaultFundingAmount() throws InterruptedException, MessagingException, IOException {
...
//					test.log(Status.INFO, "Confirm button clicked from confirm account selection page");
				...
				//Account Funding
					...
					String defamnt=getElement(ObjectRepository.shrcrtfct_txt).getAttribute("value");
					Assert.assertTrue(defamnt.contains("1,000"));
					test.log(Status.INFO, "Default amount for Certificate of Deposit account appearing correctly");
