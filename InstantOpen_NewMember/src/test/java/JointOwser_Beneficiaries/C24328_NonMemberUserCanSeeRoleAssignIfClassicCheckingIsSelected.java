...
public class C24328_NonMemberUserCanSeeRoleAssignIfClassicCheckingIsSelected extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can see role assign if Classic Checking is selected
	 */
	...
	@Test
	public void C24328_NonMemberUserCanSeeRoleAssignIfClassicCheckingIsSelected() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String expectedProducts[] = new String[]{"Classic Checking","Share"};
...
//					
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can see role assign if Classic Checking is selected");
		}
	}
