...
public class C25045_VerifyRegularMortageLoanPayment extends GenericKeywords {
	...
	@Test
	public void C25045_VerifyRegularMortageLoanPayment() throws InterruptedException
	{
...
// Enter Amount
		...
		MobileElement el4 = (MobileElement) driver.findElement(By.xpath("//android.widget.EditText[@resource-id='amountEdit']"));
		el4.setValue("65.12");
...
// Enter Memo		
		...
		getElement(ObjectRepository.loan_contbtn).click();
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Regular Mortage Loan Payment scenario working fine");
		}
	}
