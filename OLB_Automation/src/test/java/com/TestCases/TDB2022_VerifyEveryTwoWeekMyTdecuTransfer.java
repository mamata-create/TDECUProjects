...
public class TDB2022_VerifyEveryTwoWeekMyTdecuTransfer extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB2022 - Verify Every Two weeks MyTdecu Transfer
	 */
	...
	@Test
	public void TDB2022_VerifyEveryTwoWeekMyTdecuTransfer() throws InterruptedException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Every Two Weeks My TDECU account transfer scenario working fine");
		}
	}
