...
public class TDB2624_VerifyViewTransferActivity  extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2624_VerifyViewTransferActivity() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		verifyElementPresent(ObjectRepository.trnsfrActvty);
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify View Transfer Activity scenario working fine");
	}
}
