...
public class C23618_VerifyAlertEnablingDisabling  extends GenericKeywords {
	...
	//Verify menu item option
		...
		test.log(Status.INFO, "Date Alert Off noddle selected");
		Thread.sleep(4000);
...
// Switch ALert to On
		...
		getElement(ObjectRepository.alrt_on).click();
		test.log(Status.INFO, "Date Alert On noddle selected");
		Thread.sleep(4000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify alert enabling and disabling scenario working fine");
		}
	}
