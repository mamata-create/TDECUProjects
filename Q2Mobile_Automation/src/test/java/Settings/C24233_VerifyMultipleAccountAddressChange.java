...
public class C24233_VerifyMultipleAccountAddressChange  extends GenericKeywords {
	...
	@Test
	public void C24233_VerifyMultipleAccountAddressChange() throws InterruptedException
	{
	...
	//Verify menu item option
		...
		Thread.sleep(2000);	
		getElement("//android.view.View[contains(@content-desc,'"+scndacnt+"')]").click();
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Multiple Account Address Change scenario working fine");
		}
	}
