...
public class VerifyValidationWithTROMultpleCheckAccount  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify validation with TRO multiple check accounts
	 */
	...
	@Test
	public void VerifyValidationWithTROMultpleCheckAccount() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify validation with TRO multiple check accounts scenario working fine");
		}
	}
