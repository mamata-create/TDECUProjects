...
public class C24206_VerifyLengthofEmploymentFields extends GenericKeywords{
  ...
  @Test
  public void C24206_VerifyLengthofEmploymentFields() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information, current length of employment fields for existing member");
		}
	}
