...
public class TDB1448_VerifyAccountLastFourDigit extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-1448
	 */
	@Test
	public void TDB1448_VerifyAccountLastFourDigit() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify My Account dashboard 				
					...
					scrollToElement("//android.widget.TextView[contains(@text,'"+acntNumber+"')]", 4);
					...
					test.log(Status.INFO, "Accounts last four digits appearing correctly on accounts dashboard page");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Account Last Four Digits scenario working fine");
		}
	}
