...
public class TDB2605_VerifyEveryTwoWeekOtherTdecuTransfer extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB2605 - Verify Every Two weeks Other Tdecu Transfer
	 */
	...
	@Test
	public void TDB2605_VerifyEveryTwoWeekOtherTdecuTransfer() throws InterruptedException
	{
	...
	//Select Frequency as Every Two week	
		scrollToElement(ObjectRepository.frequencydrop);
		selectDropdownOpt(ObjectRepository.frequencydrop,"Every Two Weeks");
		verifyDropdownSelection(ObjectRepository.frequencydrop,"Every Two Weeks");
		test.log(Status.INFO, "Frequency selected as Every Two Weeks" );
	//Enter description	
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Every Two weeks Other TDECU account transfer scenario working fine");
		}
	}
