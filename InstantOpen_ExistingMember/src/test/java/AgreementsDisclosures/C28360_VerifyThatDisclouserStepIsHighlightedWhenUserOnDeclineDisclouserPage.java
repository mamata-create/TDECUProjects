...
public class C28360_VerifyThatDisclouserStepIsHighlightedWhenUserOnDeclineDisclouserPage extends GenericKeywords{
  ...
  @Test
  public void C28360_VerifyThatDisclouserStepIsHighlightedWhenUserOnDeclineDisclouserPage() throws InterruptedException, MessagingException, IOException {
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("ProdData", 0, startIter)))
				{
					...
					for(WebElement eachOption :returnElements(ObjectRepository.progressBarOptions)){
						...
						if(text_from_option.equalsIgnoreCase("Disclosures") && class_prop.equals("JourneyBarCurrent")){
							Assert.assertTrue(true, "Disclosures icon is currently selected and highlighted on the page");
							return;
