...
public class C24264_NonMemberUserShouldNotSeeEDocumentLinkIfNotSelected extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Non member user should not see e-document link if it is not selected as additional service
	 */
	...
	@Test
	public void C24264_NonMemberUserShouldNotSeeEDocumentLinkIfNotSelected() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Name suffix entered");
					...
					verifyElementNotPresent(ObjectRepository.eDocumentLink);
...
//						Assert.assertTrue(true, "eDocument page is launched with url: "+eDocLinkFromPage);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Non member user should not see e-document link if it is not selected as additional service");
		}
	}
