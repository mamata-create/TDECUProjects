...
public class C23510_VerifyMakeRecurringConsumerLoanPayment extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Recurring Make Consumer Loan Payment
	 */
	...
	@Test
	public void C23510_VerifyMakeRecurringConsumerLoanPayment() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Amount entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Recurring Make Consumer loan payment scenario working fine");
		}
	}
