...
public class C23484_VerifyAccountBalanceAlertSetupViaTextMessage extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Account Balance alert SetUp via Text Message
	 * 
	 */
	...
	@Test
	public void C23484_VerifyAccountBalanceAlertSetupViaTextMessage() throws InterruptedException, MessagingException, IOException
	{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify Alerts page title
					...
					js1.executeScript("arguments[0].value='"+phone+"';", getElement(ObjectRepository.alrtcall_phone));
					
					
					
					Thread.sleep(2000);
					getElement(ObjectRepository.alrtcall_phone).click();
					getElement(ObjectRepository.alrtcall_phone).sendKeys(Keys.TAB);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Account Balance Alert Setup Via Text Message scenario working fine");
		}
	}
