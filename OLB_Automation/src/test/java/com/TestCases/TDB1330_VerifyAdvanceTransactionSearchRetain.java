...
public class TDB1330_VerifyAdvanceTransactionSearchRetain extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB1330 - Verify advance transaction search retain
	 */
	...
	@Test
	public void TDB1330_VerifyAdvanceTransactionSearchRetain() throws InterruptedException {
	...
	//verifyText(ObjectRepository.dscrptnrow, keyword);
	scrollToElement(ObjectRepository.kywrdsrchcriteria);
	verifyText(ObjectRepository.kywrdsrchcriteria, keyword);
	test.log(Status.INFO, "Keyword Search criteria retained after search applied");
	Thread.sleep(4000);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Advance Transaction Search Retain scenario working fine");
		}
	}
