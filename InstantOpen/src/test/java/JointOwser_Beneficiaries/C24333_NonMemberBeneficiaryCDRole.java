...
public class C24333_NonMemberBeneficiaryCDRole extends GenericKeywords{
	...
	@Test
	public void C24333_NonMemberBeneficiaryCDRole() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData(sheetName, 0, startIter)))
				 {
					...
					selectDropdownOpt(ObjectRepository.selectTermDropdown,"6");
					getElement(ObjectRepository.termCheckBox).click();
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify beneficiary Certificate of Deposit roles for Non member");
		}
	}
