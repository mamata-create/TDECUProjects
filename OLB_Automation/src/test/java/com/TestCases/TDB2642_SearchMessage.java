...
public class TDB2642_SearchMessage extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB2642-Verify Search Message
	 */
	...
	public void setUp(){
		...
		@Test
		public void TDB2642_SearchMessage() throws InterruptedException
				{
					...
					public void afterMethod(ITestResult result) throws Throwable{
						...
						{
							test.log(Status.PASS, "Search Message scenario working fine");
						}
					}
