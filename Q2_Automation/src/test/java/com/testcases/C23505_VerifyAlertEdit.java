...
public class C23505_VerifyAlertEdit extends GenericKeywords {
	...
	@Test
	public void C23505_VerifyAlertEdit() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Alert Edit scenario working fine");
		}
	}
