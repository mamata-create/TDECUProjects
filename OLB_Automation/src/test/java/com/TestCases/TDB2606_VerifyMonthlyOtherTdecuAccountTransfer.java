...
public class TDB2606_VerifyMonthlyOtherTdecuAccountTransfer extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	
	/*
	 * TDB2606 - Verify Monthly Other TDECU Account transfer
	 */
	...
	@Test
	public void TDB2606_VerifyMonthlyOtherTdecuAccountTransfer()throws InterruptedException{
	...
	//select frequency as Monthly and Until you cancel	
		...
		Thread.sleep(2000);
		selectDropdownOpt(ObjectRepository.howlongdrop,"Until You Cancel");
