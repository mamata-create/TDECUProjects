...
public class TDB2258_VerifyMonthlyMyTdecuAccountTransfer extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2258
	 */
	@Test
	public void TDB2258_VerifyMonthlyMyTdecuAccountTransfer() throws InterruptedException{
		...
		//Click Continue button from Start date page	
			...
			public void afterMethod(ITestResult result) throws Throwable{
				...
				{
					test.log(Status.PASS, "Monthly MYTDECU account transfer scenario working fine");
				}
			}
