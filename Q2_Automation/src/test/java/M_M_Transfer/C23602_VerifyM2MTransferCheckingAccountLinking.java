...
public class C23602_VerifyM2MTransferCheckingAccountLinking   extends GenericKeywords {
...
//				
	...
	@Test
	public void C23602_VerifyM2MTransferCheckingAccountLinking() throws InterruptedException, MessagingException, IOException
	{
		...
		test.log(Status.INFO, "Checking Account Number entered");
		
		selectDropdownOptContain(ObjectRepository.mtm_acnttyp_dropdown, acnttyp);
		test.log(Status.INFO, "Account type as Checking Account selected");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Savings account Linking for M2M transfer scenario working fine");
		}
	}
