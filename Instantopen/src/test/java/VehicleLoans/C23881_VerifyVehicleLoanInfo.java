...
public class C23881_VerifyVehicleLoanInfo extends GenericKeywords{
  ...
  @Test
  public void C23881_VerifyVehicleLoanInfo() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Vehicle Loan Info page for new member");
		}
	}
