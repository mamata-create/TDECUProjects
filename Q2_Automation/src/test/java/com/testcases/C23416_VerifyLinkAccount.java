...
public class C23416_VerifyLinkAccount  extends GenericKeywords {
	...
	@Test
	public void C23416_VerifyLinkAccount() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Link Account scenario working fine");
		}
	}
