...
public class TDB2255_VerifyDailyMyTdecuAccountTransfer extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2255_VerifyDailyMyTdecuAccountTransfer() throws InterruptedException{
...
//					System.out.println(getElement(ObjectRepository.success_msg).getText());
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Daily MYTDECU account transfer scenario working fine");
		}
	}
