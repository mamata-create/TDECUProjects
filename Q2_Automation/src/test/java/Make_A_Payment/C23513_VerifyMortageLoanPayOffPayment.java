...
public class C23513_VerifyMortageLoanPayOffPayment   extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Mortage Loan payoff Payment
	 */
	...
	@Test
	public void C23513_VerifyMortageLoanPayOffPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Mortage loan payoff payment scenario working fine");
		}
	}
