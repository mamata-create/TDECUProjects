...
public class C23548_VerifyLoginWithInValidPassword  extends GenericKeywords {
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify login with invalid password scenario working fine");
		}
	}
