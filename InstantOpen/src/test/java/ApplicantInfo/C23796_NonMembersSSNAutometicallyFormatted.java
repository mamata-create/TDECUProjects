...
public class C23796_NonMembersSSNAutometicallyFormatted extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that user''s SSN should formatted autometically
	 */
	@BeforeTest
	...
	@Test
	public void C23796_NonMembersSSNAutometicallyFormatted() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData(sheetName, 0, startIter)))
				 {
					...
					getElement(ObjectRepository.ssn_txt).sendKeys("123-45-6789");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that user''s SSN should formatted autometically");
		}
	}
