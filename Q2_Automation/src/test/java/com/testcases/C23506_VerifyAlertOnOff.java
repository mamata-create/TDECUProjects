...
public class C23506_VerifyAlertOnOff extends GenericKeywords {
	...
	@Test
	public void C23506_VerifyALertOnOff() throws InterruptedException, MessagingException, IOException
	{
				//Click Settings Menu
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Alert On/Off scenario working fine");
		}
	}
