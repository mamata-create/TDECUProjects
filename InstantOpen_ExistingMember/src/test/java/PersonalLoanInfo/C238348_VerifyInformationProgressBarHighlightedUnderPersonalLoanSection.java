...
/*
 * As an existing member, I expect the Information step to be highlighted when I am on the Personal Loan Info page.
 * */
public class C238348_VerifyInformationProgressBarHighlightedUnderPersonalLoanSection extends GenericKeywords{
  ...
  @Test
  public void C238348_VerifyInformationProgressBarHighlightedUnderPersonalLoanSection() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "As an existing member, I expect the Information step to be highlighted when I am on the Personal Loan Info page.");
		}
	}
