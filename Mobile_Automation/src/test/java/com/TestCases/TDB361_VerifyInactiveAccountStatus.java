...
public class TDB361_VerifyInactiveAccountStatus extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-361
	 */
	@Test
	public void TDB361_VerifyInactiveAccountStatus() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify My Account dashboard 				
					...
					test.log(Status.INFO, "Inactive Account Status verified successfully");
