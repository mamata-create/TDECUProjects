...
public class C24209_VerifyLengthofPrevEmpFields extends GenericKeywords{
  ...
  @Test
  public void C24209_VerifyLengthofPrevEmpFields() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information, previous length of employment fields for existing member");
		}
	}
