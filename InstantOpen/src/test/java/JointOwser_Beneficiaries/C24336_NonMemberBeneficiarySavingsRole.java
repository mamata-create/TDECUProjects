...
public class C24336_NonMemberBeneficiarySavingsRole extends GenericKeywords{
	...
	@Test
	public void C24336_NonMemberBeneficiarySavingsRole() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify beneficiary savings account roles for Non member");
		}
	}
