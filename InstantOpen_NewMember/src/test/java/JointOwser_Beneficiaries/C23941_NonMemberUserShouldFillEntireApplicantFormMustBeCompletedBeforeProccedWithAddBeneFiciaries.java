...
public class C23941_NonMemberUserShouldFillEntireApplicantFormMustBeCompletedBeforeProccedWithAddBeneFiciaries extends GenericKeywords {
	...
	@Test
	public void C23941_NonMemberUserShouldFillEntireApplicantFormMustBeCompletedBeforeProccedWithAddBeneFiciaries() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user should complete the Applicant Form before checking Add Beneficiaries checkbox");
		}
	}
