...
public class C24192_VerifyLivedAtAddressFields extends GenericKeywords{
  ...
  @Test
  public void C24192_VerifyLivedAtAddressFields() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information how long have you lived at this address fields for existing member");
		}
	}
