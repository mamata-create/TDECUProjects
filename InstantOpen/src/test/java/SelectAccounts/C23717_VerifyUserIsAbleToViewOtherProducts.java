...
public class C23717_VerifyUserIsAbleToViewOtherProducts extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify User is able to view other products
	 */
	...
	@Test
	public void C23717_VerifyUserIsAbleToViewOtherProducts() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					expandProductDetailsValidateandCollapse();
