...
public class C23944_NonMemberUserCanAddOneBeneficiaryToTheApplicationForm extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can add One Beneficiary to the application form
	 */
	...
	@Test
	public void C23944_NonMemberUserCanAddOneBeneficiaryToTheApplicationForm() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can add One Beneficiary to the application form");
		}
	}
