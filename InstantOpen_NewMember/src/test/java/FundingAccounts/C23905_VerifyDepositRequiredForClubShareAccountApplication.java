...
public class C23905_VerifyDepositRequiredForClubShareAccountApplication  extends GenericKeywords{
  ...
  @Test
  public void C23905_VerifyDepositRequiredForClubShareAccountApplication() throws InterruptedException, MessagingException, IOException {
	  if(continuetestcase==true)
	  {
			...
			{	
				...
				//checking account option selected	
					...
					test.log(Status.INFO, "Dont want to open Classic checking account option selected");
				...
				//Club Share Account
					...
					test.log(Status.INFO, "Saving Account panel expanded");
					
								
					getElement(ObjectRepository.club_opt).click();
					test.log(Status.INFO, "Club Share check box selected");
...
//					
				...
				//Account Funding
					...
					verifyText(ObjectRepository.errordiv, "Please enter an amount for Club Account between $1.00 and $2,500.00");
					test.log(Status.INFO, "Error message  appearing correctly for not entering allowed club share amount appearing correctly");
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Deposit required for Club Share Account Application scenario working fine");
		}
	}
