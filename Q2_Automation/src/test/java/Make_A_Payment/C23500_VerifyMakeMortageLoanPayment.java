...
public class C23500_VerifyMakeMortageLoanPayment extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make mortage Loan Payment
	 */
	...
	@Test
	public void C23500_VerifyMakeMortageLoanPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify make mortage loan payment scenario working fine");
		}
	}
