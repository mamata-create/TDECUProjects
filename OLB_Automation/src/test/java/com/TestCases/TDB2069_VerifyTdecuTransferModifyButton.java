...
public class TDB2069_VerifyTdecuTransferModifyButton extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2069_VerifyTdecuTransferModifyButton() throws InterruptedException{
	...
	//Verify Confirm details 	
		...
		verifyElementPresent(ObjectRepository.modify_btn);
		test.log(Status.INFO, "Modify button verified" );
		
		getElement(ObjectRepository.modify_btn).click();
		test.log(Status.INFO, "Modify button clicked" );
		
		verifyElementPresent(ObjectRepository.fromacntdroparw);
		test.log(Status.INFO, "Transfer screen appears on clicking modify button" );
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify TDECU TRansfer Modify button click scenario working fine");
	}
}
