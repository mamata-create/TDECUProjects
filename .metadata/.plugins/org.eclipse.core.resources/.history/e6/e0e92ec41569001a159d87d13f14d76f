...
public class C23961_Verify_NonMember_RegistrationFormValidation extends GenericKeywords {
	 ...
	 * Creation Date: 03/16/2020 Created By: Ashish
	 * Completed Date : 03/18/2020
	 */
	@BeforeTest
	...
	public void C23961_Verify_NonMember_RegistrationFormValidation()
		...
		if (continuetestcase == true) {
			...
			validFormFillup();// This fuction will add data in all the required fields.
			...
			//step 7-8-9
			validate_txt_Field(ObjectRepository.dateofbirth_txt, dob,ObjectRepository.estric_dob,"Please enter a valid date.","You must be at least 18 to join.");
		
			test.log(Status.PASS, "DOB Field Verified Successfully");
			
			//Step 10-11
			validate_dropdown_Field(ObjectRepository.idtyp_drop,idType, ObjectRepository.estric_idType, "Please select an ID Type");
			
			test.log(Status.PASS, "ID Type Field Verified Successfully");
			
			
			//step 12-13-14
			validate_dropdown_dependent_Field(ObjectRepository.idtyp_drop,"Drivers License",ObjectRepository.state_drop ,"Texas", ObjectRepository.estric_state, "Please select a State");
			test.log(Status.PASS, "State Field Verified Successfully");
	
			//step 15-16-17
			validate_dropdown_dependent_Field(ObjectRepository.idtyp_drop,"Passport",ObjectRepository.country_drop ,"UNITED STATES",ObjectRepository.estric_country, "Please select a Country");
			test.log(Status.PASS, "Country Field Verified Successfully");
			
			//step 18-19-20
			validate_txt_Field(ObjectRepository.idnmbr_txt, idNumber,ObjectRepository.estric_idNumber,"Please enter an ID Number");
			test.log(Status.PASS, "ID Number Field Verified Successfully");
			
			
			//step 21-22-23
			validate_txt_Field(ObjectRepository.issuedt_cal, issueDate,ObjectRepository.estric_issuedate,"Please enter an Issue Date");
			test.log(Status.PASS, "Issue Date Field Verified Successfully");
			
			
			//step 24-25-26
			validate_txt_Field(ObjectRepository.expdt_cal, expiryDate,ObjectRepository.estric_expirydate,"Please enter an Expiration Date");
			test.log(Status.PASS, "Expiry Date Field Verified Successfully");
		

			//step 27 -28
			validate_dropdown_Field(ObjectRepository.hrabttdecu_drop,hearAbout_opt, ObjectRepository.estric_hearAbout_opt, "Please Tell Us How You Heard About Us");
			test.log(Status.PASS, "How did you hear about TDECU?, Field Verified Successfully");
			
			//step 29-30-31-32 
			//selectDropdownOpt(ObjectRepository.hrabttdecu_drop, "TDECU Employee Referral");
			
			//step 33-34-35
			validate_txt_Field(ObjectRepository.mothername_txt, mother_name,ObjectRepository.estric_mothersmaiden,"Please enter your mothers maiden name.");
			test.log(Status.PASS, "Mothers Maiden Name Field Verified Successfully");
			
			//step 36-37-38
			validate_txt_Field(ObjectRepository.crrntemplyr_txt,currentEmployer ,ObjectRepository.estric_currentEmployer,"Please enter some text.");
			test.log(Status.PASS, "Current Employer Field Verified Successfully");
			
			
			//step 39-40-41
			validate_txt_Field(ObjectRepository.occptn_txt,occupation ,ObjectRepository.estric_occupation,"Please enter some text.");
