...
public class TDB2241_VerifyDestinationAccountNickname extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2241
	 */
	@Test
	public void TDB2241_VerifyDestinationAccountNickname() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Select To Account	
					...
					test.log(Status.INFO, "Destination Account Contains Account Nickname");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Destination Account Nickname scenario working fine");
		}
	}
