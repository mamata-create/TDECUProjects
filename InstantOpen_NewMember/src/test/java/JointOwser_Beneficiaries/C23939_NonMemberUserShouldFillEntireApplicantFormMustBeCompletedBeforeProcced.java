...
public class C23939_NonMemberUserShouldFillEntireApplicantFormMustBeCompletedBeforeProcced extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user should complete the Applicant Form before checking Joint Owner checkbox
	 */
	...
	@Test
	public void C23939_NonMemberUserShouldFillEntireApplicantFormMustBeCompletedBeforeProcced() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					//Log all errors from the page
					List<WebElement>allErros = retrunElements(ObjectRepository.allErrors);
					for(WebElement eachElement:allErros){
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user should complete the Applicant Form before checking Joint Owner checkbox");
		}
	}
