...
public class C24234_VerifyChangeMyAddressOptionUnderSettings extends GenericKeywords {
	...
	@Test
	public void C24234_VerifyChangeMyAddressOptionUnderSettings() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Change My Address option scenario working fine");
		}
	}
