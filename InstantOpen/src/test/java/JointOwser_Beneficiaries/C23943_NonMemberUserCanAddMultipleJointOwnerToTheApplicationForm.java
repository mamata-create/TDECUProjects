...
public class C23943_NonMemberUserCanAddMultipleJointOwnerToTheApplicationForm extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can add Multiple Joint Owner to the application form
	 */
	...
	@Test
	public void C23943_NonMemberUserCanAddMultipleJointOwnerToTheApplicationForm() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Current Employer name entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can add Multiple Joint Owner to the application form");
		}
	}
