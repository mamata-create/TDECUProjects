...
public class C24330_NonMemberUserCanSeeTheRoleAssignPageWhileSelectingCreditCard extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can see role assign page when select Credit Card as a option
	 */
	...
	@Test
	public void C24330_NonMemberUserCanSeeTheRoleAssignPageWhileSelectingCreditCard() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String toggelCheckBoxLocator = "//td[contains(text(),'Classic MasterCard')]/following::span[2]";
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can see role assign page when select Credit Card as a option");
		}
	}
