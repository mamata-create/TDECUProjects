...
public class C24205_VerifyMonthlyIncomeField extends GenericKeywords{
  ...
  @Test
  public void C24205_VerifyMonthlyIncomeField() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information, current gross monthly income field for existing member");
		}
	}
