...
public class C23527_VerifyCommercialLoanGreaterThanAmountPayment  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Commercial Loan greater than amount Payment
	 */
	...
	@Test
	public void C23527_VerifyCommercialLoanGreaterThanAmountPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Commercial loan greater than amount payment scenario working fine");
		}
	}
