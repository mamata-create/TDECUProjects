...
public class TDB2081_VerifySourceAccountInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2081_VerifySourceAccountInTransactionDetail() throws InterruptedException{
	...
	//Verify scheduled tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctnsrcacnt, frmAcnt);
		test.log(Status.INFO, "Source Accout verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Source Account in Transaction Detail scenario working fine");
	}
}
