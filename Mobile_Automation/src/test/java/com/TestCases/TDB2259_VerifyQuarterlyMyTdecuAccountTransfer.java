...
public class TDB2259_VerifyQuarterlyMyTdecuAccountTransfer  extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2259_VerifyQuarterlyMyTdecuAccountTransfer() throws InterruptedException{
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Quarterly MYTDECU account transfer scenario working fine");
		}
	}
