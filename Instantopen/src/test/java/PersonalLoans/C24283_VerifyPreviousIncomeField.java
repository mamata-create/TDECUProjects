...
public class C24283_VerifyPreviousIncomeField extends GenericKeywords{
  ...
  @Test
  public void C24283_VerifyPreviousIncomeField() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information, previous  monthly income field for non member");
		}
	}
