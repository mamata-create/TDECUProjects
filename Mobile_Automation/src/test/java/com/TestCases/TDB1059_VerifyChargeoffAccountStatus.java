...
public class TDB1059_VerifyChargeoffAccountStatus extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-1059
	 */
	@Test
	public void TDB1059_VerifyChargeoffAccountStatus() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify My Account dashboard 				
					...
					test.log(Status.INFO, "Chargeoff Account Status verified successfully");
