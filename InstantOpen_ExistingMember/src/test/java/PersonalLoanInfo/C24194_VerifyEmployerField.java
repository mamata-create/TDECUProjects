...
public class C24194_VerifyEmployerField extends GenericKeywords{
  ...
  @Test
  public void C24194_VerifyEmployerField() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information, current employer field for existing member");
		}
	}
