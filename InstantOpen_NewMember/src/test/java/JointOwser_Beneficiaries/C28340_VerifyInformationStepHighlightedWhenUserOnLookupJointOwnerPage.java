...
public class C28340_VerifyInformationStepHighlightedWhenUserOnLookupJointOwnerPage extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * As an applicant, I expect the Information step to be highlighted when I am on the Lookup Joint Owners page.
	 */
	...
	@Test
	public void C28340_VerifyInformationStepHighlightedWhenUserOnLookupJointOwnerPage() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "As an applicant, I expect the Information step to be highlighted when I am on the Lookup Joint Owners page.");
		}
	}
