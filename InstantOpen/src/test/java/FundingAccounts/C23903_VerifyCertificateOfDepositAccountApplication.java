...
public class C23903_VerifyCertificateOfDepositAccountApplication  extends GenericKeywords{
  ...
  @Test
  public void C23903_VerifyCertificateOfDepositAccountApplication() throws InterruptedException, MessagingException, IOException {
	  if(continuetestcase==true)
	  {
			...
			{	
				...
				//Certificate of Deposit
					...
					test.log(Status.INFO, "Term selected for certificate of deposit");
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Certificate of Deposit Account Application scenario working fine");
		}
	}
