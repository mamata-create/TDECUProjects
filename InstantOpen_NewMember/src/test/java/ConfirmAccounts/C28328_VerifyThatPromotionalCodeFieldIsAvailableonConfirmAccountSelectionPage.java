...
public class C28328_VerifyThatPromotionalCodeFieldIsAvailableonConfirmAccountSelectionPage extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * Validate Promotional Code on Account Selection Page
	 */
	@BeforeTest
	...
	@Test
	public void C28328_VerifyThatPromotionalCodeFieldIsAvailableonConfirmAccountSelectionPage() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData(sheetName, 0, startIter)))
				 {
					...
					String promoCode_disclaimer_text = "Only one promo code per Member. Terms and conditions apply to all TDECU promotions. Please contact us for additional details.";
					String invalid_promoCode_message = "The promo code you entered is not valid.";
...
//					test.log(Status.INFO, "Name suffix entered");
					...
					//PromoCode field is present
					verifyElementPresent(ObjectRepository.add_promocode_field);
					
					//Validate PromoCode disclaimer
					verifyText(ObjectRepository.promo_code_disclaimer,promoCode_disclaimer_text);
					
					//Enter Invalid PromoCode and validate Error message
					getElement(ObjectRepository.add_promocode_field).sendKeys("RateBank");
					getElement(ObjectRepository.cnfrm_btn).click();
					verifyText(ObjectRepository.errorMsg1,invalid_promoCode_message);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Validate Promotional Code on Account Selection Page");
		}
	}
