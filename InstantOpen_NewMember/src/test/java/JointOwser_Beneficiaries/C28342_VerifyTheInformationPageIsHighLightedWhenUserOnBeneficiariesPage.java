...
public class C28342_VerifyTheInformationPageIsHighLightedWhenUserOnBeneficiariesPage extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 *  As an applicant, I expect the Information step to be highlighted when I am on the Beneficiaries page.
	 */
	...
	@Test
	public void C28342_VerifyTheInformationPageIsHighLightedWhenUserOnBeneficiariesPage() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, " As an applicant, I expect the Information step to be highlighted when I am on the Beneficiaries page.");
		}
	}
