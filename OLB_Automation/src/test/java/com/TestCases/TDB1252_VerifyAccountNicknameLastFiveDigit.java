...
public class TDB1252_VerifyAccountNicknameLastFiveDigit extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB1252 - Verify Account Number Last Five Digit and Account nickname
	 */
	...
	@Test
	public void TDB1252_VerifyAccountNicknameLastFiveDigit() throws InterruptedException
	{
	...
	if(actnickname.contains(nickname)){
		Assert.assertTrue(true);
		test.log(Status.INFO, "Account Nickname appearing");
	}else{
		Assert.assertTrue(false);
	}
				 }
