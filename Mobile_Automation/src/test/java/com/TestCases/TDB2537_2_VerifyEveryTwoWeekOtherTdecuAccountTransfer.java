...
public class TDB2537_2_VerifyEveryTwoWeekOtherTdecuAccountTransfer extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2537-2 Verify Every two week Other TDECU Account Transfer
	 */
	@Test
	public void TDB2537_2_VerifyEveryTwoWeekOtherTdecuAccountTransfer() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//amount entering and click Continue button 	
					...
					Thread.sleep(2000);
				//Select frequency as Every two weeks	
					getElement(ObjectRepository.evrytwoweek_opt).click();
					test.log(Status.INFO, "Every two week option selected");
					Thread.sleep(3000);
					
				//Date range option selected
					getElement(ObjectRepository.dtrange_opt).click();
					test.log(Status.INFO, "date range option selected");
					Thread.sleep(3000);
				...
				//Click Continue button from Start date page	
					...
					Thread.sleep(2000);
					getElement(ObjectRepository.nxtmonth).click();
					test.log(Status.INFO, "Next month clicked");
					Thread.sleep(2000);
					getElement("//android.widget.TextView[@text='25']").click();
					getElement(ObjectRepository.continue_btn).click();
					Thread.sleep(2000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Every two week Other TDECU account transfer scenario working fine");
		}
	}
