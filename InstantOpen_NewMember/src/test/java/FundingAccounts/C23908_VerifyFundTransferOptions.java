...
public class C23908_VerifyFundTransferOptions  extends GenericKeywords{
  ...
  @Test
  public void C23908_VerifyFundTransferOptions() throws InterruptedException, MessagingException, IOException {
	  if(continuetestcase==true)
	  {
			...
			//Membership Eligibility page		
				...
				//Account Funding
					...
					verifyElementNotPresent("//label[contains(text(),'Mail')]");
					test.log(Status.INFO, "Mail funding option not appearing ");
				 }
			}
	  }
  }
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify fund transfer options scenario working fine");
		}
	}
