...
public class C23963_NonMemberUserCanModifyTheJointOwnerInfo extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can change and modify existing joint owner info
	 */
	...
	@Test
	public void C23963_NonMemberUserCanModifyTheJointOwnerInfo() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String checkedFlag = getElement("//span[@id='cbAddJointOwners']//div").getAttribute("class");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can change and modify existing joint owner info");
		}
	}
