...
public class C25180_VerifyEditTransactionCategory extends GenericKeywords {
	...
	@Test
	public void C25180_VerifyEditTransactionCategory() throws InterruptedException, MessagingException, IOException
	{
		...
		if(continuetestcase==true)
		{
			...
			getElement(ObjectRepository.trnsctn_row).click();
			test.log(Status.INFO, "transactions option menu clicked");
			Thread.sleep(5000);
					
			getElement(ObjectRepository.ctgry_edt).click();
