...
public class TDB1230_VerifyAccountsDashboardOption extends GenericKeywords{
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB1230 - Verify Account Dashboard Option
	 */
	@BeforeTest
	public void setUp(){
	...
	@Test
	public void TDB1230_VerifyAccountsDashboardOption() throws InterruptedException
	{
		...
		verifyElementPresent(ObjectRepository.acntsbold);
		test.log(Status.INFO, "Accounts tab as bold verified" );
		//Click Transfer Pay 				
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Account Dashboard option scenario working fine");
		}
	}
