...
public class TDB2249_VerifyMyTdecuTransferAmountEnter extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2249	
	 */
	@Test
	public void TDB2249_VerifyMyTdecuTransferAmountEnter() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//amount entering and click Continue button 	
				...
				//Select frequency as daily	
					getElement(ObjectRepository.daily_opt).click();
					test.log(Status.INFO, "Daily option selected");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify My Tdecu Transfer Amount Enter scenario working fine");
		}
	}
