...
public class C24247_VerifyPrintOptionForChangedAddresses extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Print option for multiple changed addresses
	 */
	...
	@Test
	public void C24247_VerifyPrintOptionForChangedAddresses() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Print option is visible under Activity Center");
		}
	}
