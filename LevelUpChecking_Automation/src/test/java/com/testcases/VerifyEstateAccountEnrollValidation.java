...
public class VerifyEstateAccountEnrollValidation  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Estate account enroll validation
	 */
	...
	@Test
	public void VerifyEstateAccountEnrollValidation() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Estate account enroll validation scenario working fine");
		}
	}
