...
public class C24191_VerifyHousingPaymentField extends GenericKeywords{
  ...
  @Test
  public void C24191_VerifyHousingPaymentField() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan information housing payment field for existing member");
		}
	}
