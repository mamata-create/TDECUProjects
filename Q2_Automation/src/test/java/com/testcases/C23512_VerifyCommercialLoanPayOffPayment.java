...
public class C23512_VerifyCommercialLoanPayOffPayment extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Commercial Loan payoff Payment
	 */
	...
	@Test
	public void C23512_VerifyCommercialLoanPayOffPayment() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					selectDropdownOptContain(ObjectRepository.mkpymnt_pymnttyp, "Payoff and Close");
					test.log(Status.INFO, "Payment Type selected");
					
					getElement(ObjectRepository.mkpymnt_amnt).clear();
					getElement(ObjectRepository.mkpymnt_amnt).sendKeys(amnt);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Commercial loan payoff payment scenario working fine");
		}
	}
