...
public class C23604_VerifyCheckingAccountM2MSingleTransfer   extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify M2M Single transfer to Checking account 
	 * 
	 */
	...
	@Test
	public void C23604_VerifyCheckingAccountM2MSingleTransfer() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify M2M Single transfer to Checking account scenario working fine");
		}
	}
