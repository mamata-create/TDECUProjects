...
public class TDB1237_VerifyCreditCardLastFourDigit extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB1237 - Verify Credit Card Last Four Digit 
	 */
	...
	@Test
	public void TDB1237_VerifyCreditCardLastFourDigit() throws InterruptedException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Credit Card Last four digit scenario working fine");
		}
	}
