...
public class TDB2021_VerifyWeeklyMyTdecuAccountTransfer extends GenericKeywords {
	...
	@Test
	public void TDB2012_VerifyWeeklyMyTdecuAccountTransfer()throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//Verify Confirm details 	
				...
				verifyText(ObjectRepository.confirm_noOfRecurrences,noOfRecurrences);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Weekly My TDECU account transfer scenario working fine");
		}
	}
