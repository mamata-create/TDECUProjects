...
public class C24332_NonMemberBeneficiaryPersonalLoanRole extends GenericKeywords{
	...
	@Test
	public void C24332_NonMemberBeneficiaryPersonalLoanRole() throws InterruptedException, MessagingException, IOException
	{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				if(this.getClass().getSimpleName().equals(excl.getCellData(sheetName, 0, startIter)))
				{
					...
					String loanAmt=excl.getCellData(sheetName, 21, startIter);
					...
					getElement(ObjectRepository.productPageNext).click();
					verifyElementPresent(ObjectRepository.jointRoleDisabled(1));
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify beneficiary Personal Loan roles for Non member");
		}
	}
