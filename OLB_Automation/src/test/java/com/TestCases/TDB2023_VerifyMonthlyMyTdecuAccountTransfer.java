...
public class TDB2023_VerifyMonthlyMyTdecuAccountTransfer extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	
	/*
	 * TDB2023 - Verify Monthly My TDECU Account Transfer
	 */
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Monthly My TDECU account transfer scenario working fine");
		}
	}
