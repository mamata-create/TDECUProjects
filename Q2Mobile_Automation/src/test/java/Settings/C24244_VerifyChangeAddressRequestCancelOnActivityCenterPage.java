...
public class C24244_VerifyChangeAddressRequestCancelOnActivityCenterPage extends GenericKeywords {
	...
	@Test
	public void C24244_VerifyChangeAddressRequestCancelOnActivityCenterPage() throws InterruptedException
	{
	...
	//Verify menu item option
		...
		getElement(ObjectRepository.cncl_lnk).click();
		test.log(Status.INFO, "Cancel link clicked");
		Thread.sleep(4000);	
		
		verifyElementPresent(ObjectRepository.cncl_wrngmsg);
		test.log(Status.INFO, "Cancel confirmation message appearing");
		Thread.sleep(4000);	
		...
		verifyElementPresent(ObjectRepository.cncl_sccsmsg);
		test.log(Status.INFO, "Cancel success message appearing");
