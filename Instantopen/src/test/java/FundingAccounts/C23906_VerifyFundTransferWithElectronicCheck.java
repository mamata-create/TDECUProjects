...
public class C23906_VerifyFundTransferWithElectronicCheck   extends GenericKeywords{
  ...
  @Test
  public void C23906_VerifyFundTransferWithElectronicCheck() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify fund transfer with electronic check scenario working fine");
		}
	}
