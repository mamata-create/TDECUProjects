...
public class C28357_VerifyDisclouserStepIsHighLightedWhenUserOnAgreementsAndDisclouserPage extends GenericKeywords  {
	ExtentReports extent;
	ExtentTest test;
	/*
	 * As an applicant, I expect the Disclosures step to be highlighted when I am on theAgreements and Disclouser page
	 */
	@BeforeTest
	...
	@Test
	public void C28357_VerifyDisclouserStepIsHighLightedWhenUserOnAgreementsAndDisclouserPage() throws InterruptedException, MessagingException, IOException
	{
...
//					test.log(Status.INFO, "Name suffix entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "As an applicant, I expect the Disclosures step to be highlighted when I am on theAgreements and Disclouser page");
		}
	}
