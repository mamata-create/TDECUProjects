...
public class C23488_VerifyOnlineTransactionAlertDelete extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Online Transaction Alert Delete
	 */
	...
	@Test
	public void C23488_VerifyOnlineTransactionAlertDelete() throws InterruptedException, MessagingException, IOException
	{
					//Click Settings Menu
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Online Transaction Alert Delete scenario working fine");
		}
	}
