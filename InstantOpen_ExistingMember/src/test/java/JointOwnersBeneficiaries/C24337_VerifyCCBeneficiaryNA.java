...
public class C24337_VerifyCCBeneficiaryNA extends GenericKeywords{
  ...
  @Test
  public void C24337_VerifyCCBeneficiaryNA() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify beneficiary option not avaialable when only credit card is selected for existing member");
		}
	}
