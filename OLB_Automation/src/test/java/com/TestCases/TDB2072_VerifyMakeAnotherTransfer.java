...
public class TDB2072_VerifyMakeAnotherTransfer extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2072_VerifyMakeAnotherTransfer() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		verifyElementPresent(ObjectRepository.makeanothertrnsfrbtn);
		getElement(ObjectRepository.makeanothertrnsfrbtn).click();
		test.log(Status.INFO, "Make Another transfer button available and clicked");
		Thread.sleep(4000);
		verifyElementPresent(ObjectRepository.transferscreentitle);
		test.log(Status.INFO, "Transfer screen title is verified" );
	//Click Continue button for MYTDECU Accounts	
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Make Another transfer scenario working fine");
	}
}
