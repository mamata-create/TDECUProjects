...
public class C24325_NonMemberUserCanSeeTheAssignedRoleToTheJointOwner extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can see the assigned role of the Joint Owner
	 */
	...
	@Test
	public void C24325_NonMemberUserCanSeeTheAssignedRoleToTheJointOwner() throws InterruptedException, MessagingException, IOException
	{
