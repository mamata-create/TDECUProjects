...
public class TDB2079_VerifyTransferAmountInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2079_VerifyTransferAmountInTransactionDetail() throws InterruptedException{
	...
	//Verify scheduled tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.schdltrnsctnamnt, amnt);
		test.log(Status.INFO, "Transaction Amount verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify transfer Amount in Transaction Detail scenario working fine");
	}
}
