...
public class TDB1312_VerifyRefNumberInTransactionDetail extends GenericKeywords {
	
	ExtentReports extent;
	ExtentTest test;
/*
 * TDB-1312 - Verify Reference Number in TRansaction Detail
 */
	...
	@Test
	public void TDB1312_VerifyRefNumberInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctnref, expRefNumber);
		test.log(Status.INFO, "Reference number verified in transaction detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Reference Number in Transaction Detail scenario working fine");
	}
}
