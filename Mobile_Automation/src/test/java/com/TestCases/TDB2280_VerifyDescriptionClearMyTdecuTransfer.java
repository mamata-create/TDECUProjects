...
public class TDB2280_VerifyDescriptionClearMyTdecuTransfer extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2280_VerifyDescriptionClearMyTdecuTransfer() throws InterruptedException{
...
//amount entering and click Continue button 	
	...
	//Verify Confirm page , enter description and click Confirm	
		...
		Thread.sleep(2000);
		getElement(ObjectRepository.descclr).click();
		test.log(Status.INFO, "Clear icon clicked in description field");
		Thread.sleep(2000);
		Assert.assertEquals(getElement(ObjectRepository.desc_txt).getText(), "");
		test.log(Status.INFO, "Clicking on Clear icon cleared the description field");
				 }
			 }
		}
