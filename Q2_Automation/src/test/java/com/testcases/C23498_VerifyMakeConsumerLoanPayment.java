...
public class C23498_VerifyMakeConsumerLoanPayment extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Consumer Loan Payment
	 */
	...
	@Test
	public void C23498_VerifyMakeConsumerLoanPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Consumer loan payment scenario working fine");
		}
	}
