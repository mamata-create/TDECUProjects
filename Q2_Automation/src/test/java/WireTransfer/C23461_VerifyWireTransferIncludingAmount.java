...
public class C23461_VerifyWireTransferIncludingAmount extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Wire Transfer including amount
	 */
	...
	@Test
	public void C23461_VerifyWireTransferIncludingAmount() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Wire Transfer including amount scenario working fine");
		}
	}
