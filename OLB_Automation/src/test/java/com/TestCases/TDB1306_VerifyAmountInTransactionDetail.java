...
public class TDB1306_VerifyAmountInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB1306_VerifyAmountInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctnamnt, amnt);
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Amount in Transaction Detail scenario working fine");
	}
}
