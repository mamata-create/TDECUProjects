...
public class C24279_VerifyAdditionalProductsAreSeparatedIntoAdditionalAccordions extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Additional products are separated into additional accordions
	 */
	...
	@Test
	public void C24279_VerifyAdditionalProductsAreSeparatedIntoAdditionalAccordions() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					test.log(Status.INFO, "All additional product info validated");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Additional products are separated into additional accordions");
		}
	}
