...
public class TDB1411_VerifyRoutingNumberforAccount extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-1411
	 */
	@Test
	public void TDB1411_VerifyRoutingNumberforAccount() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify My Account dashboard 				
					...
					WebElement parentStatus=getElement("//android.widget.TextView[@text='Routing Number']/parent::*");
					String actStatus=parentStatus.findElement(By.xpath("//android.widget.TextView[@index='1']")).getText();
					System.out.println("Actual Routing Number is -"+actStatus);
					
					Assert.assertTrue(actStatus.contains("x"+acntStatus));
					test.log(Status.INFO, "Last Five digits of Routing number verified successfully");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Last Five digits of Routing number scenario working fine");
		}
	}
