...
public class C24217_MoneyMarketProduct extends GenericKeywords {
	...
	@Test
	public void C24217_MoneyMarketProduct() throws InterruptedException, MessagingException, IOException
	{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Lets Get Started page	
					scrollToElement(ObjectRepository.moneyMarketAccounts);
					getElement(ObjectRepository.moneyMarketAccounts).click();
					getElement(ObjectRepository.moneyMarket_CheckBox).click();
