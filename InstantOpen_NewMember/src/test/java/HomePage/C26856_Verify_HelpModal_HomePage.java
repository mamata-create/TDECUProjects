...
public class C26856_Verify_HelpModal_HomePage extends GenericKeywords {
	...
	/*
	 * As an applicant, I would like to have a help modal to understand what
	 * qualifies for Government issued identification. Creation Date: 03/12/2020
	 * Created By: Ashish
	 */
	@BeforeTest
		...
		if (continuetestcase == true) {
			...
			for (int questionMark = 1; questionMark < 3; questionMark++) {
				...
				test.log(Status.INFO,
						"A government issued ID includes driver’s license, passport, military ID or state ID. Displayed");
