...
public class C24245_VerifyChangeAddressListedInActivityCenter extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Changed addresses listed in Activity Center
	 */
	...
	@Test
	public void C24245_VerifyChangeAddressListedInActivityCenter() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Changed addresses liste in Activity Center");
		}
	}
