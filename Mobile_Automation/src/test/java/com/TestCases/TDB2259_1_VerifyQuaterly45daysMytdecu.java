...
public class TDB2259_1_VerifyQuaterly45daysMytdecu  extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2259_1_VerifyQuaterly45daysMytdecu() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//amount entering and click Continue button 	
				...
				//Select frequency as quarterly	
					...
					test.log(Status.INFO, "Start date after 45 days selected");
					Thread.sleep(2000);
					getElement(ObjectRepository.continue_btn).click();
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Quarterly MYTDECU account transfer 45days scenario working fine");
		}
	}
