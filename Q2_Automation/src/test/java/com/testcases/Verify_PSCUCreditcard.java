...
public class Verify_PSCUCreditcard  extends GenericKeywords {
	...
	@Test
	public void Verify_PSCUCreditcard() throws InterruptedException, MessagingException, IOException
	{
			 ...
			 {	
				...
				//Verify Stop Payment page title
				  ...
				  //  verifyElementPresent(ObjectRepository.addcrd_ttl);
					...
					scrollToElement(ObjectRepository.cncl_btn);
					Thread.sleep(3000);
				    //click cancel					
