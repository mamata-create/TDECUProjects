...
public class C23831_VerifyMembershipEligibilityMemberOptionSelection extends GenericKeywords{
  ...
  @Test
  public void C23831_VerifyMembershipEligibilityMemberOptionSelection() throws InterruptedException, MessagingException, IOException {
	  if(continuetestcase==true)
	  {
			...
			// click - view list of companies link
					...
					getElement(ObjectRepository.orglist_lnk).click();
					test.log(Status.INFO, "View List of Membership organizations link clicked under Member option");
					...
					Set<String> windowHandles=driver.getWindowHandles();
					 for(String handle: windowHandles){
							...
							test.log(Status.INFO, "Organizations list page title appearing correctly");
						    
				            System.out.println("Closing the new window...");
				            driver.close();
				            test.log(Status.INFO, "Organizations list window closed");
				            }
				        }
