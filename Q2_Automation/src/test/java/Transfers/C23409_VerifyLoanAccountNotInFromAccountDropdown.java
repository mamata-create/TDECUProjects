...
public class C23409_VerifyLoanAccountNotInFromAccountDropdown extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Loan Accounts not available in From Account dropdown
	 */
	...
	@Test
	public void C23409_VerifyLoanAccountNotInFromAccountDropdown() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					for(int count=1;count<=allOptions.size();count++){
						...
						if(!option.contains(frmacnts)){
							...
							test.log(Status.INFO, "Loan account not available inside the From account dropdown");
						}else{
							Assert.assertTrue(false);
							test.log(Status.INFO, "Loan account available inside the From account dropdown");
						}
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify loan account not available in from account dropdown scenario working fine");
		}
	}
