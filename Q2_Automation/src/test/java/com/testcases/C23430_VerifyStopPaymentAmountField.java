...
public class C23430_VerifyStopPaymentAmountField extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Stop Payment Amount Field
	 */
	...
	@Test
	public void C23430_VerifyStopPaymentAmountField() throws InterruptedException, MessagingException, IOException
	{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify Stop Payment page title
					...
					getElement(ObjectRepository.stppaymnt_amnttab).click();
					test.log(Status.INFO, "Amount tab clicked");
					Thread.sleep(3000);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Stop payments Amount Field scenario working fine");
		}
	}
