...
public class C23945_NonMemberUserCanAddMultipleBeneficiariesToTheApplicationForm extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify that Non member user can add Multiple Beneficiaries to the application form
	 */
	...
	@Test
	public void C23945_NonMemberUserCanAddMultipleBeneficiariesToTheApplicationForm() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					getElement(ObjectRepository.zip_txt).sendKeys(zipcode);
					test.log(Status.INFO, "Zip code entered");
					String Newssn2 = excl.getCellData(sheetName, 21, startIter);
					Newssn2 = Newssn2+num;
					getElement(ObjectRepository.ssn_txt).sendKeys(Newssn2);
					test.log(Status.INFO, "SSN entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify that Non member user can add Multiple Beneficiaries to the application form");
		}
	}
