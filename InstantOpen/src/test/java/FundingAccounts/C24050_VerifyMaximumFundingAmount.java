...
public class C24050_VerifyMaximumFundingAmount  extends GenericKeywords{
  ...
  @Test
  public void C24050_VerifyMaximumFundingAmount() throws InterruptedException, MessagingException, IOException {
	  if(continuetestcase==true)
	  {
			...
			{	
				...
				//Certificate of Deposit option selected	
					...
					test.log(Status.INFO, "Amount entered for certificate of Deposit");
					
					selectDropdownOpt(ObjectRepository.crtfctdpst_trm, "3");
					test.log(Status.INFO, "certificate of Deposit term filtered");
					Thread.sleep(2000);
					getElement(ObjectRepository.crtfctdpst_trmopt3).click();
					test.log(Status.INFO, "Certificate of Deposit term selected");
			...
			//Membership Eligibility page		
				...
				//Account Funding
					...
					getElement(ObjectRepository.clscchkng_txt).sendKeys("50001");
					test.log(Status.INFO, "Classic Checking Account amount entered");
					
					getElement(ObjectRepository.share_txt).sendKeys("50000");
					test.log(Status.INFO, "Share Account amount entered");
					
					getElement(ObjectRepository.sbmtapp_btn).click();
					test.log(Status.INFO, "Submit Application button clicked");
					
					verifyText(ObjectRepository.errordiv, "The maximum funding amount is $100,000.00. Please adjust your amount and try again");
					test.log(Status.INFO, "Error message  appearing correctly for entering more than allowed funding amount appearing correctly");
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify maximum funding account scenario working fine");
		}
	}
