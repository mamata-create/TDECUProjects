...
public class C23529_VerifyMortageLoanPaidOffPayment extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Mortage Loan paid off Payment
	 */
	...
	@Test
	public void C23529_VerifyMortageLoanPaidOffPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Mortage loan paid off payment scenario working fine");
		}
	}
