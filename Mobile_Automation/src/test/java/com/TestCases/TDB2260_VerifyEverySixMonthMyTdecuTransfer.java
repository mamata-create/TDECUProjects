...
public class TDB2260_VerifyEverySixMonthMyTdecuTransfer extends GenericKeywords {
	...
	public void TDB2260_VerifyEverySixMonthMyTdecuTransfer() throws InterruptedException{
		...
		//Click Continue button from Start date page	
			...
			public void afterMethod(ITestResult result) throws Throwable{
				...
				{
					test.log(Status.PASS, "Every Six months MYTDECU account transfer scenario working fine");
				}
			}
