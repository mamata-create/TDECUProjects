...
public class C24297_VerifySelectOneTaxOption extends GenericKeywords{
	...
	@Test
	public void C24297_VerifySelectOneTaxOption() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify only Backup Withholding or Exempt Recipients can "
					+ "be selected on Agreement and Disclosures page for Non member");
		}
	}
