...
public class C23508_VerifyMakeRecurringCommercialLoanPayment   extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Recurring Commercial Loan payoff Payment
	 */
	...
	@Test
	public void C23508_VerifyMakeRecurringCommercialLoanPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Recurring Commercial loan payoff payment scenario working fine");
		}
	}
