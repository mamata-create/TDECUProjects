...
public class TDB1054_VerifyNonAccuralAccountStatus extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-1054
	 */
	@Test
	public void TDB1054_VerifyNonAccuralAccountStatus() throws InterruptedException{
			 ...
			 {	
				...
				//Verify My Account dashboard 				
					...
					WebElement ele=driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView("
                            + "new UiSelector().text(\"Account Status\"));"));
					...
					test.log(Status.INFO, "NonAccural Account Status verified successfully");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify NonAccural Account Status scenario working fine");
		}
	}
