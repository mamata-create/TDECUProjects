...
public class C24237_VerifyChangeAddressForAllAccount extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Address Change for All Accounts
	 */
	...
	@Test
	public void C24237_VerifyChangeAddressForAllAccount() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Address change for All Accounts working Fine");
		}
	}
