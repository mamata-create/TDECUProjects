...
public class TDB2242_VerifyDestinationAccountLastFiveDigit extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2242
	 */
	@Test
	public void TDB2242_VerifyDestinationAccountLastFiveDigit() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Select To Account	
					...
					WebElement parentElement=getElement("//android.widget.TextView[contains(@text,'"+toAccnt+"')]");
					String actnickname=parentElement.getText();
				    System.out.println("Actual Name is-"+actnickname);
				
					Assert.assertTrue(actnickname.contains("..."+toAccnt));
					test.log(Status.INFO, "Destination Account appears with last five digit of account number");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Destination Account Last Five Digit scenario working fine");
		}
	}
