...
public class C23714_VerifyMemberToMemberSingleTransferWithInValidToAccount   extends GenericKeywords {
	...
	@Test
	public void C23714_VerifyMemberToMemberSingleTransferWithInValidToAccount() throws InterruptedException
	{
	...
	//Fill mandatory fields
		...
		test.log(Status.INFO, "MTM single transfer with invalid to account number validation Message appeared");
		...
		//Fill mandatory fields
				...
				getElement(ObjectRepository.mtm_toacnt).sendKeys("1234.56");
				test.log(Status.INFO, "To Account Number entered");
				Thread.sleep(3000);
				...
				test.log(Status.INFO, "MTM single transfer with restricted to account number validation Message appeared");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Member to Member Single Transfer with incorrect to account number scenario working fine");
		}
	}
