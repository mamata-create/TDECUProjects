...
public class TDB2083_VerifyFrequencyInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2083_VerifyFrequencyInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctnfrqncy, "Once");
		test.log(Status.INFO, "Frequency in transaction detail verified");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Frequency in Transaction Detail scenario working fine");
	}
}
