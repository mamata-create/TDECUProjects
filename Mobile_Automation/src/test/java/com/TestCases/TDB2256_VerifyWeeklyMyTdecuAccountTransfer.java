...
public class TDB2256_VerifyWeeklyMyTdecuAccountTransfer extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2256_VerifyWeeklyMyTdecuAccountTransfer() throws InterruptedException{
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Weekly MYTDECU account transfer scenario working fine");
		}
	}
