...
public class TDB2087_VerifyNotesInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2087_VerifyNotesInTransactionDetail() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctnnotes, desc);
		test.log(Status.INFO, "Transaction Notes verified on the transaction detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Notes in Transaction Detail scenario working fine");
	}
}
