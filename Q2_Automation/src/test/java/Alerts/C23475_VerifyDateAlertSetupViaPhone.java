...
public class C23475_VerifyDateAlertSetupViaPhone extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Date alert SetUp via phone
	 * 
	 */
	...
	@Test
	public void C23475_VerifyDateAlertSetupViaPhone() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Date Alert Setup Via Phone scenario working fine");
		}
	}
