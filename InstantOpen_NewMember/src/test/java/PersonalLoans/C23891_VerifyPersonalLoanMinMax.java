...
public class C23891_VerifyPersonalLoanMinMax extends GenericKeywords{
  ...
  @Test
  public void C23857_VerifyPersonalLoanMinMax() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify personal loans min and max for non member");
		}
	}
