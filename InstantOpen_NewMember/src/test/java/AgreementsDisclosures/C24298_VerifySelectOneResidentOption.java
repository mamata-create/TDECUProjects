...
public class C24298_VerifySelectOneResidentOption extends GenericKeywords{
	...
	@Test
	public void C24298_VerifySelectOneResidentOption() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify only U.S. or non resident can be selected on"
					+ "the Agreement and Disclosures page for Non member");
		}
	}
