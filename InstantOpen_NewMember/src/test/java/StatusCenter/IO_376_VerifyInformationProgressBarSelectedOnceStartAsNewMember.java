...
public class IO_376_VerifyInformationProgressBarSelectedOnceStartAsNewMember extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Information icon is selected and highlighted when start as a New Member and procced
	 */
	...
	@Test
	public void IO_376_VerifyInformationProgressBarSelectedOnceStartAsNewMember() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Information icon is selected and highlighted when start as a New Member and procced");
		}
	}
