...
public class TDB2260_1_VerifyEvery6Months45daysMyTdecu extends GenericKeywords{
	...
	/*
	 * Test Cases covered -- TDB-2259
	 */
	@Test
	public void TDB2260_1_VerifyEvery6Months45daysMyTdecu() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//amount entering and click Continue button 	
					...
					Thread.sleep(2000);
				//Select frequency as EveruSixMonths	
					getElement(ObjectRepository.evrysixmonth_opt).click();
					test.log(Status.INFO, "EverySixMonth option selected");
					Thread.sleep(3000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify EverySixMonths MYTDECU account transfer 45days scenario working fine");
		}
	}
