...
/*
 * As an existing member, I expect the Products step to be highlighted when I am on the Select Product page.
 * */

public class C28347_VerifyProductsProgressBarHighlightedWhenOnSelectProductPage extends GenericKeywords{
  ...
  @Test
  public void C28347_VerifyProductsProgressBarHighlightedWhenOnSelectProductPage() {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
	  	...
	  	test.log(Status.PASS, "As an existing member, I expect the Products step to be highlighted when I am on the Select Product page.");
	  }
  }
