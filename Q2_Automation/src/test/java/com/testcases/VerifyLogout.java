...
public class VerifyLogout extends GenericKeywords {
    ...
    */
    ...
    public void VerifyLogout() throws InterruptedException, MessagingException, IOException

    {
           ...
           test.log(Status.INFO, "Register button clicked");
