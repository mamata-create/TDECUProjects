...
public class TDB2537_5_VerifyEverySixMonthOtherTdecuTransfer extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2260_VerifyEverySixMonthMyTdecuTransfer() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 ...
			 //amount entering and click Continue button 	
					...
					Thread.sleep(2000);
		//Select Every Six month as frequency			
		getElement(ObjectRepository.evrysixmonth_opt).click();
		test.log(Status.INFO, "Every Six month option selected");
		Thread.sleep(3000);
		...
		//Click Continue button from Start date page	
			...
			public void afterMethod(ITestResult result) throws Throwable{
				...
				{
					test.log(Status.PASS, "Every Six months Other TDECU account transfer scenario working fine");
				}
			}
