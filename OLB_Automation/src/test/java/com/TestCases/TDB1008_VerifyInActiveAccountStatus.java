...
public class TDB1008_VerifyInActiveAccountStatus extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * TD1008 - Verify InActive Account Status
	 */
	...
	@Test
	public void TDB1008_VerifyInActiveAccountStatus() throws InterruptedException
			{
							...
							if(this.getClass().getSimpleName().equals(excl.getCellData("AccountStatusCheck", 0, startIter)))
							 {
								...
								test.log(Status.INFO, "scrolled to InActive account");
								childelement.click();
								Thread.sleep(30000);
								test.log(Status.INFO, "InActive Account clicked");
								...
								verifyText(ObjectRepository.checkAccountStatus,"InActive");
								test.log(Status.INFO, "InAccount Status correctly Available");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify InActive Account Status scenario working fine");
		}
	}
