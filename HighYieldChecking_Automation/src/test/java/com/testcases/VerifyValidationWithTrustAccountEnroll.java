...
public class VerifyValidationWithTrustAccountEnroll  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify validation with Trust account
	 */
	...
	@Test
	public void VerifyValidationWithTrustAccountEnroll() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify validation with Trust accounts scenario working fine");
		}
	}
