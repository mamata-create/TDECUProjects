...
public class C23607_VerifyAccountAlertSetup   extends GenericKeywords {
	...
	@Test
	public void C23607_VerifyAccountAlertSetup() throws InterruptedException
	{
	...
	//select account alert type again	
		...
		verifyElementPresent(ObjectRepository.alrt_nofld);
		test.log(Status.INFO, "No Account and No field selected messages appearing");
...
//		Thread.sleep(4000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Account Alert Setup scenario working fine");
		}
	}
