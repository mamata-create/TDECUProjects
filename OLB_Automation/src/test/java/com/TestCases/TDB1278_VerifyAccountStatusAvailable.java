...
public class TDB1278_VerifyAccountStatusAvailable extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * TD1278 - Verify Account Status Available
	 */
	...
	@Test
	public void TDB1278_VerifyAccountStatusAvailable() throws InterruptedException
			{
							...
							if(this.getClass().getSimpleName().equals(excl.getCellData("AccountStatusCheck", 0, startIter)))
							 {
								...
								test.log(Status.INFO, "Account Status Available");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Account Status Available scenario working fine");
		}
	}
