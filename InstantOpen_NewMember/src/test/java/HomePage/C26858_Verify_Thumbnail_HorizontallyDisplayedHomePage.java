...
public class C26858_Verify_Thumbnail_HorizontallyDisplayedHomePage extends GenericKeywords {
	...
	/*
	 * As TDECU, I would like to redesign the different options on the Instant
	 * Open landing page so they appear horizontally. 
	...
	@Test
	public void C26858_Verify_Thumbnail_HorizontallyDisplayedHomePage()
