...
/*
 *  As an existing member, I expect the Information step to be highlighted when I am on the Credit Card Information page.
 * */
public class C28346_VerifyInformationProgressBarHighLightedOnceInCreditCardInfoScreen extends GenericKeywords{
  ...
  @Test
  public void C28346_VerifyInformationProgressBarHighLightedOnceInCreditCardInfoScreen() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, " As an existing member, I expect the Information step to be highlighted when I am on the Credit Card Information page.");
		}
	}
