...
public class TDB1055_VerifyDormantAccountStatus extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-1055
	 */
	@Test
	public void TDB1055_VerifyDormantAccountStatus() throws InterruptedException{
			...
			for(startIter=1;startIter<=totalRowCount;startIter++) //It is mandatory to have this for loop in every test case
			 {	
				...
				//Verify My Account dashboard 				
					...
					test.log(Status.INFO, "Dormant Account Status verified successfully");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify Dormant Account Status scenario working fine");
		}
	}
