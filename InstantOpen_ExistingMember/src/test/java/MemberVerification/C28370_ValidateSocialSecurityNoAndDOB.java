...
public class C28370_ValidateSocialSecurityNoAndDOB extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * As an existing Member, I would like to validate my identity by entering my Social Security Number and Date of Birth
	 */
	...
	@Test
	public void C28370_ValidateSocialSecurityNoAndDOB() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "As an existing Member, I would like to validate my identity by entering my Social Security Number and Date of Birth");
		}
	}
