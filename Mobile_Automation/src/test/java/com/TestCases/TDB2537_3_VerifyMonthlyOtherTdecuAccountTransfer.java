...
public class TDB2537_3_VerifyMonthlyOtherTdecuAccountTransfer extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2537-3 Verify Monthly Other TDECU Account Transfer
	 */
	@Test
	public void TDB2537_3_VerifyMonthlyOtherTdecuAccountTransfer() throws InterruptedException{
		...
		getElement(ObjectRepository.monthly_opt).click();
		test.log(Status.INFO, "Monthly option selected");
		Thread.sleep(3000);
