...
public class C24289_VerifyMoreDetailsAboutEdocument extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify more details about E-document
	 */
	...
	@Test
	public void C24289_VerifyMoreDetailsAboutEdocument() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String edocumentModalBodyText = "E-Documents provide you with secure online access to your account statement and other important documents.";
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, " Verify more details about E-document");
		}
	}
