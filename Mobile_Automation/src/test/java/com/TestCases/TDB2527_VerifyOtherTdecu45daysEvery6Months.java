...
public class TDB2527_VerifyOtherTdecu45daysEvery6Months extends GenericKeywords {
	 ...
	 */
	@Test
	public void TDB2527_VerifyOtherTdecu45daysEvery6Months() throws InterruptedException{
		if(continuetestcase==true)
		{
			...
			//amount entering and click Continue button 	
				...
				//Select frequency as quarterly	
					...
					test.log(Status.INFO, "EverySixMonths option selected");
					Thread.sleep(3000);
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify EverySixMonths OTHERTDECU account transfer 45days scenario working fine");
		}
	}
