...
public class C23969_VerifyLimitOnCheckingFundingAccount  extends GenericKeywords{
  ...
  @Test
  public void C23969_VerifyLimitOnCheckingFundingAccount() throws InterruptedException, MessagingException, IOException {
...
//					
					getElement(ObjectRepository.sbmtapp_btn);
					test.log(Status.INFO, "Submit Application button clicked without entering checking account amount");
					
					verifyText(ObjectRepository.errordiv, "Please enter an amount for Classic Checking between $0.00 and $2,500.00");
					test.log(Status.INFO, "Error Messages appeared for not entering checking account amount");
				 }
			}
	  }
  }
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Limit on Checking Funding Account scenario working fine");
		}
	}
