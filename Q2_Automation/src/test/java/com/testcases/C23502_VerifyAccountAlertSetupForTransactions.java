...
public class C23502_VerifyAccountAlertSetupForTransactions extends GenericKeywords {
	...
	@Test
	public void C23502_VerifyAccountAlertSetupForTransactions() throws InterruptedException, MessagingException, IOException
	{
...
//					
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Account Balance Alert Setup for transactions scenario working fine");
		}
	}
