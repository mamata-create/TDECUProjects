...
public class VerifyMemberAgeUnder18Enroll  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Member age under 18 enroll
	 */
	...
	@Test
	public void VerifyMemberAgeUnder18Enroll() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Member age under 18 enroll validation scenario working fine");
		}
	}
