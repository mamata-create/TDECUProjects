...
public class C23719_WizardToSelectRightMoneyMarket extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * To check right certificate for Money Market
	 */
	...
	@Test
	public void C23719_WizardToSelectRightMoneyMarket() throws InterruptedException, MessagingException, IOException
	{
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("Data", 0, startIter)))
				 {
					...
					String MoneyMarketOptions ="High-yield investment account with a competitive ;$2,500 minimum deposit required ;Minimum balance must be maintained to avoid $10 monthly service charge";
					...
					getElement(ObjectRepository.subproductName("Money Market Accounts")).click();
					validateVariousOptionFromPage("MoneyMarket",MoneyMarketOptions);
					getElement(ObjectRepository.locatorAdditionalOption("Money Market")).click();
...
//					test.log(Status.INFO, "Name suffix entered");
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "To check right certificate for Money Market");
		}
	}
