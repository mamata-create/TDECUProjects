...
public class C23883_VerifyVehicleLoanMinMax extends GenericKeywords{
  ...
  @Test
  public void C23883_VerifyVehicleLoanMinMax() throws InterruptedException, MessagingException, IOException {
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify vehicle loans min and max for non member");
		}
	}
