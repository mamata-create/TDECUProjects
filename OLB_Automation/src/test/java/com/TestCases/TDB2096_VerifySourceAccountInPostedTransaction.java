...
public class TDB2096_VerifySourceAccountInPostedTransaction extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2096_VerifySourceAccountInPostedTransaction() throws InterruptedException{
	...
	//Verify Posted tab on clicking transfer activity	
		...
		test.log(Status.INFO, "Source Account verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Source Account in Posted Transaction Detail scenario working fine");
	}
}
