...
public class VerifySecondChanceAccountMemberEnroll  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Second Chance Account Member Enroll
	 */
	...
	@Test
	public void VerifySecondChanceAccountMemberEnroll() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Second Chance Account Member Enroll scenario working fine");
		}
	}
