...
public class C23511_VerifyConsumerLoanPayOffPayment  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify Make Consumer Loan payoff Payment
	 */
	...
	@Test
	public void C23511_VerifyConsumerLoanPayOffPayment() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Make Consumer loan payoff payment scenario working fine");
		}
	}
