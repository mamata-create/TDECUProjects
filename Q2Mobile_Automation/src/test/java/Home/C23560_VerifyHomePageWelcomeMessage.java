...
public class C23560_VerifyHomePageWelcomeMessage   extends GenericKeywords {
...
//			}
	...
	//Verify menu item option
		...
		verifyElementPresent(ObjectRepository.wlcm_msg);
		test.log(Status.INFO, "Welcome message appearing");
	...
	public void afterMethod(ITestResult result) throws Throwable{
		...
		{
			test.log(Status.PASS, "Verify home page welcome message scenario working fine");
		}
	}
