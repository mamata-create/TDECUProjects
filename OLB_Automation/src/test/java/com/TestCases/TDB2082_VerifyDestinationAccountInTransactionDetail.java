...
public class TDB2082_VerifyDestinationAccountInTransactionDetail extends GenericKeywords {
 ...
 */
	...
	@Test
	public void TDB2082_VerifyDestinationAccountInTransactionDetail() throws InterruptedException{
	...
	//Verify scheduled tab on clicking transfer activity	
		...
		Thread.sleep(4000);
		verifyText(ObjectRepository.trnsctntrgtacnt, toAcnt);
		test.log(Status.INFO, "Destination Accout verified successfully in Transaction Detail");
				 }
			 }
...
public void afterMethod(ITestResult result) throws Throwable{
	...
	{
		test.log(Status.PASS, "Verify Destination Account in Transaction Detail scenario working fine");
	}
}
