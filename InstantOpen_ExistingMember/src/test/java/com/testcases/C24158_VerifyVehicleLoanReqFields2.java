...
public class C24158_VerifyVehicleLoanReqFields2 extends GenericKeywords{
  ...
  @Test
  public void C24158_VerifyVehicleLoanReqFields2() throws InterruptedException, MessagingException, IOException {
				...
				if(this.getClass().getSimpleName().equals(excl.getCellData("ProdData", 0, startIter)))
				 {
					...
					String selectATV=excl.getCellData(sheetName, 2, startIter);
					...
					selectDropdownOpt(ObjectRepository.prodTypeDropdown,selectATV);
					getElement(ObjectRepository.prodInfoNextButton).click();
  ...
  public void afterMethod(ITestResult result) throws Throwable {
	  if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify vehicle loan required fields for existing member");
		}
	}
