...
public class TDB2537_6_VerifyYearlyOtherTdecuAccountTransfer extends GenericKeywords {
	...
	/*
	 * Test Cases covered -- TDB-2537_5 Verify yearly Other Tdecu Account Transfer
	 */
	@Test
	public void TDB2537_5_VerifyYearlyOtherTdecuAccountTransfer() throws InterruptedException{
		...
		//Select yearly as frequency
					scrollToElement(ObjectRepository.yearly_opt, 5);
		...
		//Click Continue button from Start date page	
			...
			public void afterMethod(ITestResult result) throws Throwable{
				...
				{
					test.log(Status.PASS, "Yearly Other TDECU account transfer scenario working fine");
				}
			}
