...
public class C24252_VerifyEdocumentAddedAsAdditionalSeviceOption extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify E-document added as AdditionalService Option
	 */
	...
	@Test
	public void C24252_VerifyEdocumentAddedAsAdditionalSeviceOption() throws InterruptedException, MessagingException, IOException
	{
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify E-document added as AdditionalService Option");
		}
	}
