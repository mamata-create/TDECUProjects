...
public class VerifyTRODeceasedMemberEnrollValidation  extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * Verify TRO deceased member enroll validation
	 */
	...
	@Test
	public void VerifyTRODeceasedMemberEnrollValidation() throws InterruptedException {
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify TRO deceased member enroll validation scenario working fine");
		}
	}
