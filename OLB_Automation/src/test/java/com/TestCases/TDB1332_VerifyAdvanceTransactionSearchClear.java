...
public class TDB1332_VerifyAdvanceTransactionSearchClear extends GenericKeywords {

	ExtentReports extent;
	ExtentTest test;
	/*
	 * TDB1332 - Verify Clear advance transaction search
	 */
	...
	@Test
	public void TDB1332_VerifyAdvanceTransactionSearchClear() throws InterruptedException {
	...
	scrollToElement(ObjectRepository.clrsrchbtn);
	verifyElementPresent(ObjectRepository.clrsrchbtn);
	test.log(Status.INFO, "Clear Search link available");
	
	getElement(ObjectRepository.clrsrchbtn).click();
	test.log(Status.INFO, "Clear Search link clicked");
	Thread.sleep(2000);
	scrollToElement(ObjectRepository.advncsrch);
	verifyElementPresent(ObjectRepository.advncsrch);
	
	test.log(Status.INFO, "Advance Search link appears after clear Search link clicked");
	Thread.sleep(4000);
	...
	public void afterMethod(ITestResult result) throws Throwable {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			test.log(Status.PASS, "Verify Clear Advance Transaction Search  scenario working fine");
		}
	}
